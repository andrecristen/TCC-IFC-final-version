...
public class QuizPegadinhas extends AppCompatActivity {

    ArrayList<Integer> numeros = new ArrayList<Integer>();
    private DesafiosPegadinhas mLivrariaQuestao = new DesafiosPegadinhas();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_quiz_pegadinhas);
    ...
    private void mudarQuestao(){
        ...
        if (mErros == 5) {
            Intent intent = new Intent(QuizPegadinhas.this, TelaFinalQuizLogica.class);
            String localizacao = "";
